...
const useWrapperForCreateResource = <T,>(id: number, fn: (id: number) => Promise<T>)
    : [
    data: undefined | (T & {
        loading: boolean;
    }),
...
export default function Home() {
    ...
    // Calendars
    const [dataCalendar1, {refetch: refetchCalendar1}] = useWrapperForCreateResource(1, readCalendar)
    const [dataCalendar2, {refetch: refetchCalendar2}] = useWrapperForCreateResource(2, readCalendar)
    const [dataCalendar3, {refetch: refetchCalendar3}] = useWrapperForCreateResource(3, readCalendar)
    const [dataCalendar4, {refetch: refetchCalendar4}] = useWrapperForCreateResource(4, readCalendar)
